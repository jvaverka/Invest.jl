...
Returns Δ of a European call & put option at some point in time `t`.

Δ is the sensitivity of the option premium with respect to the underlying derivative's
price.
...
The Gamma measures the rate of change of a derivative's ``Δ`` with respect to its
...
The Theta measures the rate of change of a derivative's price with respect to time (daily).
"""
function Θ(o::Option)
    @unpack S, K, r, σ, T, t = o
    d₁ = (log(S / K) + (r + 0.5σ^2) * (T - t)) / (σ * √(T - t))
